...
transform = BaseTransform(net.size, (104/256.0, 117/256.0, 123/256.0)) # net.size is the target of image to feed to the neural network  We create an object of the BaseTransform class, a class that will do the required transformations so that the image can be the input of the neural network.
